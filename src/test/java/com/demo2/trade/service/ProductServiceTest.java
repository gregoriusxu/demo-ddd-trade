...
public class ProductServiceTest {
	...
	/**
	 * The test show: how to save, load, delete a value object, which set join key
	 * to null, to database.
	 */
	@Test
	...
	/**
	 * The test show: how to save, load, delete a value object with one-to-many
	 * relation to database. that is said: 1) from product to supplier have a
	 * many-to-one relation, 2) to save a customer has no business with supplier. 3)
	 * load a customer then load his supplier. 4) to delete a customer has no
